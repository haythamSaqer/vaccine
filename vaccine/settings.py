...
SECRET_KEY = "django-insecure-ycfzu6djk+#!$ovh%1^64$_jjtq8r9uykds7nwszxix07i2o5="
...
INSTALLED_APPS = [
    ...
    'crispy_forms',
    'crispy_bootstrap4',
    # 'uni_form.templatetags.uni_form_tags',
...
LOGIN_URL = 'vaccines:login'
LOGIN_REDIRECT_URL = 'vaccines:vaccine_list'
